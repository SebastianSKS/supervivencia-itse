  ...
  return (
    <div className="min-h-screen bg-zinc-950">
      ...
      <main className="max-w-2xl mx-auto px-4 py-8 sm:py-14">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-1.5 text-xs sm:text-sm text-zinc-500 hover:text-zinc-300 transition-colors mb-6 sm:mb-8"
        >
        ...
        <div className="bg-zinc-900/50 border border-white/[0.06] rounded-2xl p-5 sm:p-8">
