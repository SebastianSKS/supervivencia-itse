        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          ...
          <div className="flex items-center gap-2.5 flex-wrap">
            ...
            {session ? (
              <Link
                href="/publicar"
                className="inline-flex items-center justify-center gap-2 text-xs sm:text-sm font-semibold bg-zinc-100 text-zinc-900 hover:bg-white px-4 py-2 rounded-xl transition-colors shadow-sm shrink-0"
              >
              ...
              <Link
                href="/login"
                className="inline-flex items-center justify-center gap-2 text-xs sm:text-sm text-zinc-400 hover:text-zinc-200 border border-white/10 hover:border-white/20 bg-zinc-900/40 px-4 py-2 rounded-xl transition-all shrink-0"
              >
