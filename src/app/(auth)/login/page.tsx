...
import { Shield, Mail, Lock, LogIn, Loader2, AlertCircle, ArrowLeft } from 'lucide-react';
...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -top-24 left-1/2 -translate-x-1/2 w-[520px] h-[520px] bg-gradient-to-tr from-cyan-500/10 via-indigo-500/10 to-fuchsia-500/10 rounded-full blur-3xl -z-10"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute bottom-0 right-1/4 w-[360px] h-[360px] bg-cyan-500/5 rounded-full blur-3xl -z-10"
      />
