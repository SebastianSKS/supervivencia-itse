  ...
  return (
    <div className="relative inline-flex items-center">
      {isPending ? (
        ...
        <Sparkles className="w-3.5 h-3.5 text-amber-400 absolute left-3 pointer-events-none" />
      )}
      <select
        value={currentSort}
        disabled={isPending}
        ...
        aria-label="Algoritmo y ordenamiento del muro"
      >
        <option value="random" className="bg-zinc-900 text-zinc-200">
          🎲 Para ti (Aleatorio)
        </option>
